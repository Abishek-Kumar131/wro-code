...
def main():
    ...
    # ------------------------------------------------------------------------
    # Phase 3 Parameters (Robust Return-to-Home Engine)
    # ------------------------------------------------------------------------
    ...
    home_stop_confirm_start = 0        # Debounce timer start for stop condition

    MIN_CLEAR_OF_CORNER_TIME = 1.0     # Must drive straight for at least 1.0s after turn 12 exit
    TARGET_HOME_DRIVE_TIME = 1.6       # Calibrated drive time to center vehicle inside start section
    FRONT_WALL_HARD_STOP_CM = 45.0     # Stop if front wall <= 45cm
    HOME_ABSOLUTE_TIMEOUT = 3.5        # Maximum safety timeout cap since turn-12 exit
    STOP_CONFIRM_HOLD = 0.1            # 100ms debounced hold to confirm stop condition
